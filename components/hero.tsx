  ...
  return (
    <section className="w-full -mt-18 px-3 sm:px-4 md:px-6 rounded-2xl">
      <div className="relative overflow-hidden w-full lg:min-h-screen max-w-350 mx-auto rounded-2xl sm:rounded-3xl bg-white dark:bg-neutral-950">
        ...
        <div className="absolute inset-0 z-10 pointer-events-none bg-gradient-to-t from-orange-400 via-orange-300/20 to-transparent dark:from-orange-500 dark:via-orange-400/30" />
        ...
        <div className="relative z-20 pointer-events-none flex flex-col items-center text-center pt-28 sm:pt-32 px-2">
          ...
          {/* Description */}
          <p className="mt-6 text-base sm:text-lg text-neutral-500 dark:text-neutral-400 max-w-xl leading-relaxed pointer-events-auto">
